...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--train_data_split', type=str, default='train', help='name of training part of data')
    parser.add_argument('--test_data_split', type=str, default='test', help='name of testing part of data')
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--wandb_project', type=str, default='mammoth_action', help='Wandb project name')
